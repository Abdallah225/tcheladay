...
if ( !class_exists( 'ReduxFramework_wbc_importer' ) ) {
    ...
    class ReduxFramework_wbc_importer {
        ...
        public function render() {
	        ...
	        echo '<div class="ruby-notice-import">';
	        echo '<p>Please be patient and <strong>do not navigate away</strong> from this page while the import is in the process. This may take up to several minutes ( according to servers speed). This page will automatically refresh after the import is completed.</p>';
	        echo '<p class="ruby-import-data-notice"><strong>Data Notice:</strong> We do not have right to include images of demos in the content due to copyright issue. The structures of demos will still be left intact so can use your own images in their places if you desire.</p>';
	        echo '<p class="ruby-import-tips"><strong>Import Tips:</strong><br> - Refresh this page and re-import if the process cannot complete after 5 minutes.<br>- Install and active Woocommerce plugin before importing if you want to import shop.<br> - You can disable the import demo plugin after imported.<br> - Online Documentation: <a href="http://docs.themeruby.com/bingo" target="_blank">http://docs.themeruby.com/bingo</a></a></p>';
	        echo '</div>';
