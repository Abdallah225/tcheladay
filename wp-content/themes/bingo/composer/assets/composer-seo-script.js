(function($) {
    $(document).ready(function() {
        ...
        var ComposerSeoAnalytics = function() {
            ...
            $(document).on('bingo_ruby_composer_mce', this.reloadAnalytics);
            $(document).on('bingo_ruby_composer_delete', this.reloadAnalytics);
        };
        ...
        ComposerSeoAnalytics.prototype.addContent = function(data) {
            $('#bingo_ruby_composer_editor').find('[id ^= "html-form"]').each(function() {
                var content;
                var mce_el = $(this);
