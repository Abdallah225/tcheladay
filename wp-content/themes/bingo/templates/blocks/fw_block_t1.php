<?php
/**
 * Class bingo_ruby_fw_block_t1
 */
if ( ! class_exists( 'bingo_ruby_fw_block_t1' ) ) {
	class bingo_ruby_fw_block_t1 extends bingo_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'fw-block is-block-third fw-block-t1 block-bg-full col-sm-4 col-xs-12';
