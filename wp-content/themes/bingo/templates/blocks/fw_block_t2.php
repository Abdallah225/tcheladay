 ...
 */
if ( ! class_exists( 'bingo_ruby_fw_block_t2' ) ) {
	class bingo_ruby_fw_block_t2 extends bingo_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'fw-block is-block-third  block-bg-full fw-block-t2 col-sm-4 col-xs-12';
