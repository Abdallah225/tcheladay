<?php
/**
 * Class bingo_ruby_fw_block_v1 (video playlist)
 */
if ( ! class_exists( 'bingo_ruby_fw_block_v1' ) ) {
	class bingo_ruby_fw_block_v1 extends bingo_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'fw-block fw-block-v1';
		...
		static function listing( $data_query, $options = array() ) {
			...
			while ( $data_query->have_posts() ) {
				...
				$str .= bingo_ruby_post_grid_m1( $options );
				$str .= '</div>';
			}
