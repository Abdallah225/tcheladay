<?php
/**
 * Class bingo_ruby_fw_block_t4
 */
if ( ! class_exists( 'bingo_ruby_fw_block_t4' ) ) {
	class bingo_ruby_fw_block_t4 extends bingo_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'fw-block is-block-third block-bg-full fw-block-t4 col-sm-4 col-xs-12';
