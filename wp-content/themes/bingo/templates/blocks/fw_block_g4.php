<?php
/**
 * Class bingo_ruby_fw_block_g4
 */
if ( ! class_exists( 'bingo_ruby_fw_block_g4' ) ) {
	class bingo_ruby_fw_block_g4 extends bingo_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'fw-block fw-block-g4 block-bg-full';
