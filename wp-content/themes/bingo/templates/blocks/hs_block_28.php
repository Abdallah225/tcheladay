<?php
/**
 * Class bingo_ruby_hs_block_28
 */
if ( ! class_exists( 'bingo_ruby_hs_block_28' ) ) {
	class bingo_ruby_hs_block_28 extends bingo_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block hs-block-28';
