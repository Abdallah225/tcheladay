<?php
/**
 * Class bingo_ruby_fw_block_t3
 */
if ( ! class_exists( 'bingo_ruby_fw_block_t3' ) ) {
	class bingo_ruby_fw_block_t3 extends bingo_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'fw-block is-block-third block-bg-full fw-block-t3 col-sm-4 col-xs-12';
