<?php
/**
 * Class bingo_ruby_hs_block_8
 */
if ( ! class_exists( 'bingo_ruby_hs_block_8' ) ) {
	class bingo_ruby_hs_block_8 extends bingo_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block hs-block-8 block-bg-full';
