<?php
/**
 * Class bingo_ruby_hs_block_18
 */
if ( ! class_exists( 'bingo_ruby_hs_block_18' ) ) {
	class bingo_ruby_hs_block_18 extends bingo_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block is-block-half hs-block-18 col-sm-6 col-xs-12 block-bg-full';
