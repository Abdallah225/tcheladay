<?php
/**
 * Class bingo_ruby_hs_block_21
 */
if ( ! class_exists( 'bingo_ruby_hs_block_21' ) ) {
	class bingo_ruby_hs_block_21 extends bingo_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block hs-block-21';
