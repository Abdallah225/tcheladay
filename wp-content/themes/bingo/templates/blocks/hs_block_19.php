<?php
/**
 * Class bingo_ruby_hs_block_19
 */
if ( ! class_exists( 'bingo_ruby_hs_block_19' ) ) {
	class bingo_ruby_hs_block_19 extends bingo_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block hs-block-19';
		...
		static function listing( $data_query, $options = array() ) {
			...
			while ( $data_query->have_posts() ) {
				...
				$str .= bingo_ruby_post_grid_4( $options );
				$str .= '</div><!--#post outer-->';
			}
