<?php
/**
 * Class bingo_ruby_hs_block_25
 */
if ( ! class_exists( 'bingo_ruby_hs_block_25' ) ) {
	class bingo_ruby_hs_block_25 extends bingo_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block hs-block-25';
