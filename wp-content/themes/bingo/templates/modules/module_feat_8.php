...
/**-------------------------------------------------------------------------------------------------------------------------
 * @return string
 * bingo_ruby_post_feat_8
 */
if ( ! function_exists( 'bingo_ruby_post_feat_8' ) ) {
	function bingo_ruby_post_feat_8( $options = array() ) {

		$str = '';
		$str .= '<article class="post-wrap post-feat-8">';

		if ( has_post_thumbnail() ) {
            $str .= '<div class="post-thumb-outer">';
			$str .= bingo_ruby_post_thumb_overlay();
			$str .= bingo_ruby_post_thumbnail( 'bingo_ruby_crop_300x424','is-bg-thumb');
