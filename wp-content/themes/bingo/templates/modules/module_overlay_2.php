...
/**-------------------------------------------------------------------------------------------------------------------------
 * @return string
 * bingo_ruby_post_overlay_2
 */
if ( ! function_exists( 'bingo_ruby_post_overlay_2' ) ) {
	function bingo_ruby_post_overlay_2( $options = array() ) {
		$str = '';
		$str .= '<article class="post-wrap post-overlay-2">';
