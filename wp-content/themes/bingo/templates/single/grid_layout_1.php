 ...
 *
 * @return string
 * render single post grid layout 1
 */
if ( ! function_exists( 'bingo_ruby_render_single_post_gallery_grid_1' ) ) {
	function bingo_ruby_render_single_post_gallery_grid_1() {
		...
		$class_name                    = 'single-post-wrap single-post-format-1 single-post-grid-1';
		...
		$str .= bingo_ruby_post_thumbnail_gallery( 'bingo_ruby_crop_540x540', 'single-post-thumb-outer ruby-grid-1' );
