 ...
 */
if ( ! function_exists( 'bingo_ruby_render_single_post_gallery_grid_2' ) ) {
	function bingo_ruby_render_single_post_gallery_grid_2() {
		...
		$class_name                    = 'single-post-wrap single-post-format-2 single-post-grid-2';
		...
		$str .= bingo_ruby_post_thumbnail_gallery( 'bingo_ruby_crop_540x540', 'single-post-thumb-outer ruby-grid-2' );
