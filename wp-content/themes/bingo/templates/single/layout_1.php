<?php
if ( ! function_exists( 'bingo_ruby_render_single_post_layout_1' ) ) {
	function bingo_ruby_render_single_post_layout_1( $param = array() ) {
		...
		if ( ! empty( $date_full ) ) {
			$class_name = 'single-post-wrap single-post-1 is-date-full';
		} else {
			$class_name = 'single-post-wrap single-post-1';
		}
