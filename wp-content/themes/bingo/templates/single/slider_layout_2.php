 ...
 *
 * @return string
 * render single post slider layout 2
 */
if ( ! function_exists( 'bingo_ruby_render_single_post_gallery_slider_2' ) ) {
	function bingo_ruby_render_single_post_gallery_slider_2() {
		...
		$class_name                    = 'single-post-wrap single-post-format-2 single-post-slider-2';
		...
		$str .= bingo_ruby_post_thumbnail_gallery( 'bingo_ruby_crop_750x450', 'ruby-single-slider-2' );
