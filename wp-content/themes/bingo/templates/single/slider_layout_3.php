 ...
 *
 * @return string
 * render single post slider layout 3
 */
if ( ! function_exists( 'bingo_ruby_render_single_post_gallery_slider_3' ) ) {
	function bingo_ruby_render_single_post_gallery_slider_3() {
		...
		$class_name                    = 'single-post-wrap single-post-format-3 single-post-slider-3';
		...
		$str .= bingo_ruby_post_thumbnail_gallery( 'bingo_ruby_crop_1200x750', 'single-post-thumb-outer ruby-single-slider-3' );
