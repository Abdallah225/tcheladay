...
/**-------------------------------------------------------------------------------------------------------------------------
 * @return string
 * render single post audio layout 1
 */
if ( ! function_exists( 'bingo_ruby_render_single_post_audio_1' ) ) {
	function bingo_ruby_render_single_post_audio_1() {
		...
		$class_name                    = 'single-post-wrap single-post-format-1 single-post-audio-1';
