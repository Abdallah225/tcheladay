 ...
 *
 * @return string
 * render single post slider layout 1
 */
if ( ! function_exists( 'bingo_ruby_render_single_post_gallery_slider_1' ) ) {
	function bingo_ruby_render_single_post_gallery_slider_1() {
		...
		$class_name                    = 'single-post-wrap single-post-format-1 single-post-slider-1';
		...
		$str .= bingo_ruby_post_thumbnail_gallery( 'bingo_ruby_crop_750x450', 'single-post-thumb-outer ruby-single-slider-1' );
