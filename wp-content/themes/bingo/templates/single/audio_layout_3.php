 ...
 *
 * @return string
 * render single post audio layout 3
 */
if ( ! function_exists( 'bingo_ruby_render_single_post_audio_3' ) ) {
	function bingo_ruby_render_single_post_audio_3() {
		...
		$class_name                    = 'single-post-wrap single-post-format-3 single-post-audio-3';
