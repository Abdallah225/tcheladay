<?php
if ( ! function_exists( 'bingo_ruby_render_single_post_layout_2' ) ) {
	function bingo_ruby_render_single_post_layout_2( $param = array() ) {
		...
		$class_name                    = 'single-post-wrap single-post-2';
