<?php
if ( ! function_exists( 'bingo_ruby_render_single_page_layout_4' ) ) {
	function bingo_ruby_render_single_page_layout_4() {
		...
		$class_name   = array();
		$class_name[] = 'single-page-wrap single-page-4 single-post-4';
